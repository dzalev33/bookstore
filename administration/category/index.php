        ...
        <ul class=\"nav navbar-right top-nav\">
            ...
            <li class=\"dropdown\">
                ...
                <ul class=\"dropdown-menu\">
                    ...
                    <li>
                        <a href=\"".$settings['website_url']."administration/category/insert.php\"><i class=\"fa fa-plus-circle\" aria-hidden=\"true\"></i> New Category </a>
                    </li>
            ...
            <div class=\"row\">
                <div class=\"col-lg-12\">
                    <h1 class=\"page-header\">
                        Categories <small>Admin Page</small>
                    </h1>
