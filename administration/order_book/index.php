        ...
        <ul class=\"nav navbar-right top-nav\">
            ...
            <li class=\"dropdown\">
                ...
                <ul class=\"dropdown-menu\">
                    ...
                    <li>
                        <a href=\"".$settings['website_url']."administration/order_book/insert.php\"><i class=\"fa fa-plus-circle\" aria-hidden=\"true\"></i> New Order </a>
                    </li>
